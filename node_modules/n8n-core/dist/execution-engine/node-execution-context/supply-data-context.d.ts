import type { AINodeConnectionType, CloseFunction, ExecutionBaseError, IExecuteData, INode, INodeExecutionData, IRunExecutionData, ISupplyDataFunctions, ITaskDataConnections, ITaskMetadata, IWorkflowExecuteAdditionalData, Workflow, WorkflowExecuteMode, NodeConnectionType } from 'n8n-workflow';
